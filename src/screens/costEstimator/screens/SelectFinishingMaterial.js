...
import {
  getRawMaterialByCategoryIDApi,
  getRawMaterialByFloorPlansApi,
...
const SelectFinishingMaterial = ({ navigation, route }) => {
  ...
  const sortedRawMaterialList = rawMaterialList.sort((a, b) =>
          ...
          <View style={{ flex: 1, marginTop: 0 }}>
            <View style={{ flex: 1, marginBottom: 5 }}>
              <View>
                ...
                {sortedRawMaterialList &&
                  sortedRawMaterialList.map((detail, i) => {
                    return (
                      <View
                        key={i}
                        style={[
            ...
            >
              <View style={styles.btnContainer}>
                ...
                >
                  <AppText title={"Back"} size={18} color={Colors.black} />
                </TouchableOpacity>
                <TouchableOpacity

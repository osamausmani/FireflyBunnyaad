...
const SelectPayment = ({ navigation, route }) => {
  const { constructionData } = useContext(AppContext);
    ...
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <View>
        ...
        >
          ...
          <Image
            source={
              paymentMethod.promoCode ? Icon.fill_radio : Icon.unfil_radio
            }
        ...
        >
          ...
          >
            <Image
              resizeMode="contain"
              source={Images.payNow}
              style={[styles.paynowimage]}
            />
            <AppText
              title={"Pay Now"}
              bold
          ...
          <Image
            source={
              paymentMethod.easypaisa ? Icon.fill_radio : Icon.unfil_radio
            }
            style={{ width: 22, height: 22 }}
          />
        </TouchableOpacity>

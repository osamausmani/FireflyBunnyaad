...
import iconsPath from "../../assets/path";
...
const CustomeDrawer = (props) => {
  ...
  const customData = [
    {
      route: "userProfile",
      label: Language.userProfile,
      icon: Icon.personal_icon,
      onPress: () => console.log(" user Profile Click"),
    },
    {
      route: "chatWithUs",
      label: Language.chatWithUs,
    ...
    },
    {
      ...
      label: Language.customerSupport,
      icon: Icon.supports_icon,
      onPress: () => Linking.openURL(`tel:+92 0309 7779132`),
    },
    {
      route: "termOruse",
      label: Language.termOruse,
      icon: Icon.blogs_icon,
      onPress: () => navigation.navigate("termOfUse"),
    },
    {
      route: "privacyPolicy",
      label: Language.privacyPolicy,
      icon: Icon.privacy_icon,
    ...
    },
    {
      ...
      onPress: () => {
        navigation.navigate("Home"), handleSignoutPress();
      },
    },
  ];
          ...
          >
            ...
            >
              ...
              <Image
                style={[
                  styles.arrow,
                  { transform: [{ rotate: !isEnglish ? "0deg" : "180deg" }] },
                ]}
...
const styles = StyleSheet.create({
  header: {
    ...
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: Colors.tab_title_color,

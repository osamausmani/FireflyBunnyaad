...
import { background_grey, darkgrey, darkYellow, fieldPlaceholderColor, tab_title_color, textColor } from '../../constants/Colors'
import { cross_icon } from "../../assets/path"
import { PostRequest } from '../../api/axios'
import { getCitysDDLApi, getetCustomQualityRawMaterialDetailsApi, getRawMaterialDetailsByConstructionQualityApi } from '../../api/apiEndPoint'
import { Icon, Colors, AppSubmitButton } from '../../constants'
import LinearGradient from 'react-native-linear-gradient';

const QualityShowModal = ({ visible, color, children, onPress, floorPlanId, constructionId, title, handlePlanChange, list, navigation, onPressContinue,route }) => {
            ...
            <View style={styles.modalContainer}>
                ...
                <ScrollView
                    ...
                    <View style={{ marginHorizontal: 10, flex: 1 }}>
                        {
                            rawMaterialList && rawMaterialList.map((offer, i) => {
                                return (
                                    <View key={i} style={{ marginBottom: 10 }}>
                                        <View style={{ backgroundColor: Colors.lightYello, alignItems: "center", padding: 10, borderRadius: 10, marginBottom: 3 }}>
                                            <AppText
                                        ...
                                        <View style={{ marginHorizontal: 15, flexDirection: "row", justifyContent: "space-between", marginVertical: 3 }}>

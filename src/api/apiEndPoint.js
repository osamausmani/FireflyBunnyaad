...
export const baseUrlApi =
  "http://95.216.202.81/plesk-site-preview/api.bunnyaad.com/api/";
export const imgUrl =
  "http://95.216.202.81/plesk-site-preview/api.bunnyaad.com/wwwroot/";
export const flowUrl =
  "http://95.216.202.81/plesk-site-preview/api.bunnyaad.com/";
